...
// PERF: CCWS
`define VX_CSR_MPM_CCWS_VTA_INSERTS     12'hB15
`define VX_CSR_MPM_CCWS_VTA_INSERTS_H   12'hB95
`define VX_CSR_MPM_CCWS_VTA_HITS        12'hB16
`define VX_CSR_MPM_CCWS_VTA_HITS_H      12'hB96
`define VX_CSR_MPM_CCWS_THROTTLED_LOADS 12'hB17
`define VX_CSR_MPM_CCWS_THROTTLED_LOADS_H 12'hB97
`define VX_CSR_MPM_CCWS_THROTTLED_WARPS 12'hB1C
`define VX_CSR_MPM_CCWS_THROTTLED_WARPS_H 12'hB9C
`define VX_CSR_MPM_CCWS_FALLBACK_ISSUES 12'hB18
`define VX_CSR_MPM_CCWS_FALLBACK_ISSUES_H 12'hB98
`define VX_CSR_MPM_CCWS_AVG_ACTIVE_ISSUE_CANDIDATES 12'hB19
`define VX_CSR_MPM_CCWS_AVG_ACTIVE_ISSUE_CANDIDATES_H 12'hB99
`define VX_CSR_MPM_CCWS_AVG_LLS         12'hB1A
`define VX_CSR_MPM_CCWS_AVG_LLS_H       12'hB9A
`define VX_CSR_MPM_CCWS_MAX_LLS         12'hB1B
`define VX_CSR_MPM_CCWS_MAX_LLS_H       12'hB9B
